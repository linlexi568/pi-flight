# TD3 Baseline for Pi-Flight Comparison
...
## Comparison with Pi-Flight

| Method | Type | Reward | Sample Efficiency |
|--------|------|--------|------------------|
| **Pi-Flight** | Program Search | **-31.98** | High (MCTS guided) |
...
**Key Insight**: All RL methods (SAC/TD3/PPO) far outperform classical baselines, but Pi-Flight's program search achieves the best reward by finding control structures beyond what neural networks can express with the same sample budget.
