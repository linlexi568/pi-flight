...
Usage example (PowerShell):
    .venv\\Scripts\\python.exe 01_pi_flight\\nn_training\\train_ml_sched_nn.py \
        --csv 01_pi_flight\\results\\ml_sched_samples.csv \
        --out 01_pi_flight\\results\\nn_trained\\ml_sched.pt
"""
...
def main() -> None:
    ...
    p.add_argument('--out', type=str, default='01_pi_flight/results/nn_trained/ml_sched.pt', help='导出的 TorchScript 路径')
