#!/usr/bin/env python3
"""
Pi-Flight 程序评估脚本 - 使用 SCG 精确奖励（与训练/基线完全对齐）
所有参数写在脚本顶部，直接修改即可
...
# --------------------- 程序路径 ---------------------
# 修改为你要评估的程序路径
PROGRAM_PATH = ROOT / "results" / "piflight_train" / f"{TASK}_safe_control_tracking_best.json"
...
# --------------------- 输出配置 ---------------------
OUTPUT_PATH = ROOT / "results" / "piflight_test" / f"eval_{TASK}.json"
...
def main():
    ...
    print("=" * 70)
    print(f"Pi-Flight 程序评估 - 任务: {TASK}")
    print("=" * 70)
