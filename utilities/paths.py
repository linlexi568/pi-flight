...
# Updated to new numbered folder layout; prefer 01_pi_flight for the new package.
PI_FLIGHT_RESULTS_ROOT = os.path.join(PROJECT_ROOT, '01_pi_flight', 'results')  # new default
...
def init_global_results_dirs():
    ...
    try:
        ensure_dir(PI_FLIGHT_RESULTS_ROOT)
    except Exception:
        pass
