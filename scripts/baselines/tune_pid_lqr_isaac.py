#!/usr/bin/env python3
"""
Tune PID/LQR baselines directly on π-Flight's Isaac Gym environment,
...
IsaacGymDroneEnv = _load_class_from_file(
    ROOT / '01_pi_flight' / 'envs' / 'isaac_gym_drone_env.py',
    'isaac_gym_drone_env',
    'IsaacGymDroneEnv',
)

SCGExactRewardCalculator = _load_class_from_file(
    ROOT / '01_pi_flight' / 'utils' / 'reward_scg_exact.py',
    'reward_scg_exact',
